...
namespace DataLibrary.Data
{
    public class OrderData : IOrderData
    {
        ...
        // async becasue we are modifying results of the call (just the first value), awaiting a call
        public async Task<OrderModel> GetOrderByID(int orderId)
        {
            var recs = await dataAccess.LoadData<OrderModel, dynamic>("dbo.spOrders_GetById",
                                                                        new
                                                                        {
                                                                            Id = orderId
                                                                        },
