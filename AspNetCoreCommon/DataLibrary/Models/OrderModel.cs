...
{
    // Classes in data access normally would not be "deccorated" -> Thats the UIs job
    // Tim Corey is shortcutting this!!
    ...
    public class OrderModel
    {
        ...
        [Required]
        [MaxLength(20, ErrorMessage = "You need to keep the name to a mox of 20 characters")]
